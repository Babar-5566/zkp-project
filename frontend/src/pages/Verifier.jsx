...
const Verifier = () => {
  ...
  const handleVerifyProofClick = () => {
    alert("Verify Proof flow will start here!");
    // Later, replace this with your verification animation
  };
        ...
        {step === 2 && selectedCard && (
          ...
          >
            ...
            <div className="bg-[#0B101B] border border-slate-800 rounded-3xl p-6">
              ...
              {/* GENERATE PROOF BUTTON */}
              <button
                disabled={disclosedFields.length === 0}
                onClick={startVerification}
                className="w-full py-4 bg-cyan-600 rounded-xl font-black text-white text-[10px] uppercase tracking-[3px] disabled:opacity-30"
              >
                Generate Proof
              </button>
            </div>
